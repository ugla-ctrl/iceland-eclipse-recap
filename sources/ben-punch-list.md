...
| # | Item | Detail |
|---|---|---|
| O1 | **4,200 participants vs 3,333 guests** | ~~Open~~ **Resolved.** Mitch settles it unprompted in his 2026-09-03 16:27 feedback video at 0:56: "there's never 3,333 guests, it's either 3,000 buyers or 4,200 participants, I think we want to have 4,200 participants." The deck is already correct. Separately, imxp.org/iceland-eclipse still publishes 3,333, a number Mitch does not stand behind. |
...
| O4 | **Thank You logo placement** | ~~Conflict~~ **Resolved 2026-09-05: Mitch's version.** He asked twice on video for the logo at the top with the content moved down so it is readable. Lee had asked for it at the bottom and bigger, then directed that Mitch's requests win. The logo now opens the slide and the copy, contact and date sit beneath it. |
